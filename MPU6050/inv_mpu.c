...
static int stm32_i2c_write(unsigned char slave_addr,
...
static int stm32_i2c_read(unsigned char slave_addr,
                          unsigned char reg_addr,
                          unsigned char length,
                          unsigned char *data)
{
...
// 若工程未在编译选项中显式定义 MPUxxxx，默认选择 MPU6050
// 以避免编译期 #error 并减少移植门槛。
#if !defined(MPU6050) && !defined(MPU9150) && !defined(MPU6500) && !defined(MPU9250)
#if defined(STM32F1xx) || defined(STM32F103xB) || defined(USE_HAL_DRIVER)
#define MPU6050
#endif
#endif
